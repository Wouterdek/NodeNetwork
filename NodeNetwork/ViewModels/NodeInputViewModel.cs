...
namespace NodeNetwork.ViewModels
{
	...
	public class NodeInputViewModel : Endpoint
	{
		...
		/// </summary>
		[DataMember] public bool IsEditorVisible => _isEditorVisible.Value;
		[IgnoreDataMember] private ObservableAsPropertyHelper<bool> _isEditorVisible;
		#endregion
		...
		[IgnoreDataMember] private bool _hideEditorIfConnected;
		#endregion
		...
		[IgnoreDataMember] private Func<PendingConnectionViewModel, ConnectionValidationResult> _connectionValidator;
		#endregion
